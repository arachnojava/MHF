 ...
 *
 */
public abstract class MHGuiComponent implements MHRenderable
{
    ...
    {
        MHRectangle rb = bounds.clone();
        rb.x += MHScreenManager.getDisplayOrigin().getX();
        rb.y += MHScreenManager.getDisplayOrigin().getY();
