...
public class TestSprite extends MHActor implements MHStateContext, MHAnimationListener, MHKeyListener
{
    ...
    public TestSprite()
    {
        super();
        setUpAnimations();
        animation = new MHAnimator(standAnimation);
    ...
    private void setUpAnimations()
    {
        ...
        runAnimation.addFrame(TestScreen.IMAGES_DIR+"MarioWalk1.png");
        runAnimation.setDurationMillis(50);
    ...
    public void update(long elapsedTime)
    {
        ...
        if (getX() < -10)
            ...
            getPosition().setX(-10);
        //else System.out.println("Falling...");
    }
    ...
    {
        super.render(g, x, y);
        //g.setColor(MHPlatform.createColor(255,255,255));
        //g.drawString(position.toString(), x, y-12);
    }
    ...
    public void animationFrameChanged(String imageID)
    {
        ...
        if (walkRight || walkLeft)
            System.out.println("Animaion frame: " + imageID);
    }
